...
const I18N = {
	...
	// ===== Português =====
	pt: {
		settings_title: "Definições do radar",
		settings_reset: "Repor",
		settings_reset_title: "Repor predefinições",
		settings_toggle_title: "Definições",
		settings_language: "Idioma",
		settings_confirm_reset: "Repor todas as definições?",

		group_display: "Visualização",
		group_name: "Nome",
		group_indicator: "Indicadores",
		group_advisory: "Avisos",
		group_vertIndicator: "Indicador vertical",
		group_autozoom: "Zoom automático",
		group_smoothing: "Suavização",

		showTeamPanel: "Painel das equipas",
		showTeammatePanel: "Mostrar aliados",
		showEnemyPanel: "Mostrar inimigos",
		enemyPanelSide: "Posição dos inimigos",
		rotate90_title: "Rodar 90°",
		followRotation: "Seguir rotação",
		playerDotScale: "Tamanho dos jogadores",
		bombDotScale: "Tamanho da bomba",
		tombstoneOpacity: "Opacidade dos eliminados",

		showName: "Mostrar nome",
		maxNameLength: "Tamanho máximo",

		shooting: "Disparos",
		damage: "Dano",
		flashes: "Flash",
		projectiles: "Granadas",
		smokeColors: "Cor da equipa no fumo",
		plainProjectiles: "Ícones simples",
		showWeapon: "Mostrar arma",
		showHealth: "Mostrar vida",

		hideAdvisories: "Ocultar avisos",
		showBlastRadius: "Raio da explosão",
		showBuyzones: "Zonas de compra",

		vertType: "Tipo",
		scaleDelta: "Intensidade",

		autozoomEnable: "Ativar",
		autozoomPadding: "Margem",
		autozoomMinZoom: "Zoom mínimo",

		playerSmoothing: "Suavização dos jogadores",
		projectileSmoothing: "Suavização das granadas",

		opt_never: "Nunca",
		opt_both: "Ambas",
		opt_always: "Sempre",
		opt_active: "Quando ativo",
		opt_buytime: "Tempo de compra",
		opt_off: "Desligado",
		opt_name: "Nome",
		opt_icon: "Ícone",
		opt_none: "Nenhum",
		...
		advisory_planting: "A plantar",
		advisory_defuse: "A desarmar",
		advisory_solesurvivor: "Último jogador",

		team_t: "Terroristas",
		team_ct: "Contra-Terroristas",
		team_t_empty: "Sem terroristas",
		team_ct_empty: "Sem contra-terroristas",

		page_title: "Radar CS2 — OmniGhost"
	}
}

// Current language code: "zh", "en" or "pt"
let currentLang = "pt"

/**
 * Load saved language from localStorage, falling back to Portuguese.
 */
function loadLang() {
	try {
		let saved = localStorage.getItem("webradar_lang")
		if (saved === "zh" || saved === "en" || saved === "pt") return saved
	} catch (err) { /* ignore */ }
	return "pt"
}
 ...
 * @param {String} lang "zh", "en" or "pt"
 */
function setLang(lang) {
	if (lang !== "zh" && lang !== "en" && lang !== "pt") return
