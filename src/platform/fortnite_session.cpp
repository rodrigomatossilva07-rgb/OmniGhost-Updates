...
namespace {
class FortniteSession final : public IGameSession {
public:
    explicit FortniteSession(const ServiceContainer&) : state_(SessionState::Detached) {}
    ...
    [[nodiscard]] std::string_view GetStatus() const noexcept override { return "Fortnite"; }
...
std::unique_ptr<IGameSession> CreateFortniteSession(const ServiceContainer& services) {
